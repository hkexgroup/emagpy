...
#                    self.editItem(self.item(r0,c0))
        ...
        <p> This quick start guide provides information to get you started with <b>EMagPy</b> (see also <a href="https://www.journals.elsevier.com/computers-and-geosciences/">McLachlan, Blanchy and Binely, 2020).</a> </p>
        <p> EMI methods use electromagnetic fields to characterize subsurface electrical conductivity:
           <ul>
        ...
        <p> EMI devices record data in terms of Quadrature (<b>Q</b>), however data are typically expressed as apparent conductivity (<b>ECa</b>) values as they are a more comprehensible value with the same units as conductivity [mS/m]. 
        ...
        <img width=800 src="image/fig2.png"></img>
        ...
        '''
        <p>
        <b> EmagPy </b> is suitable for modeling data collected from any commercially available frequency domain EMI devices. To do so details of the following should be specified in the data file:
<ul>
            <li> Orientation of receiver and transmitter coils.</li>
            ...
            <li> Elevation of the device in <b>metres</b>.</li>
  </ul>
<p> For example, the below table shows how the details of a device with 3 receiver coils operated at ground level, a frequency of 9000 Hz and with both HCP and PRP coil orientations.</p>
   <p>
        <br>

        <img width=800 src="image/datalayout.png"></img>
</p>
<p> Note about GF Instruments
</p>
