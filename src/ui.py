...
#                    self.editItem(self.item(r0,c0))
        ...
        <p> This quick start guide provides information to get started with <b>EMagPy</b> (see also <a href="https://www.journals.elsevier.com/computers-and-geosciences/">McLachlan, Blanchy and Binley, 2020</a>). </p>
